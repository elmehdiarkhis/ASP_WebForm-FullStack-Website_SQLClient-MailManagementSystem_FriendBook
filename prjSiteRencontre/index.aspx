<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="prjSiteRencontre.index" %>
...
<div class="container" id="container">
	...
	<div class="form-container sign-in-container">
			...
			<asp:Label ID="lblConnectionResultat" runat="server" Font-Bold="true" ForeColor="Red"></asp:Label>
	...
	<div class="overlay-container">
		<div class="overlay">
			<div class="overlay-panel overlay-right">
				...
				<asp:Button ID="btnSignUp" runat="server" Text="GO to Sign Up" CssClass="btn ghost" OnClick="btnSignup_Click" />	
			</div>
		</div>
	</div>
