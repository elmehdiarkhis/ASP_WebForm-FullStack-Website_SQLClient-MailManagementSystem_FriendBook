<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="envoyerMessage.aspx.cs" Inherits="prjSiteRencontre.envoyerMessage" %>
        ...
        <div class="timeline-left">
          ...
          <div class="pages box">
              <div style="display:flex;flex-direction:column;gap:10px">
				...
				<asp:Label ID="Label2" runat="server" Text="Destinataire Email :"></asp:Label>
				...
				<asp:Button ID="btnEnvoyer" runat="server" Text="Send" OnClick="btnEnvoyer_Click" />    
                  <br />
                <asp:Label ID="lblEnvoyer" runat="server" ForeColor="DarkGreen" Font-Bold="true"></asp:Label>
              </div>
          </div>
  ...
  <div class="right-side" :class="{ 'active': rightSide }">
    <div class="account">
      ...
      <span class="account-user">
          ...
          <asp:LinkButton CssClass="linkButton" ID="btnDisconnect" OnClick="btnDisconnect_Click" runat="server">
